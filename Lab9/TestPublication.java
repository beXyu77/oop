...
public class TestPublication {
    ...
    public static void main(String[] args) {
        ...
        pub[1] = new Magazine(null, 0, 0, null, null);
        ...
        pub[3] = new Book(null, null, 0, 0, null);
        System.out.println(pub[3].pubPrint());
        System.out.println();

        pub[4] = new Book("J.R.R Tolkein", null, 0, 0, null);
        ...
        pub[7] = new KidsMagazine(0, null, 0, 0, null);
        System.out.println(pub[7].pubPrint());
        System.out.println();

        pub[8] = new KidsMagazine(13, null, 0, 0, null);
